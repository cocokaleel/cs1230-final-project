...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Canvas2D_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Canvas2D_t qt_meta_stringdata_Canvas2D = {
    {
QT_MOC_LITERAL(0, 8) // "Canvas2D"
...
const QMetaObject Canvas2D::staticMetaObject = { {
    ...
    qt_meta_stringdata_Canvas2D.offsetsAndSize,
    qt_meta_data_Canvas2D,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Canvas2D_t
, QtPrivate::TypeAndForceComplete<Canvas2D, std::true_type>
